...
export default class Home extends Component {
  render() {
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
      <div class="container topnav">
        <div class="navbar-header">
          ...
          <div class="navbar-brand topnav elevator-button">Katie Thigpen</div>
      </div>
    ...
    <div class="content-section-a">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6">
            <hr class="section-heading-spacer" />
            <div class="clearfix"></div>
            <h2 class="section-heading">Interesting reads</h2>
            <dl class="dl-horizontal links">
      ...
      <a name="contact"></a>
      <div class="content-section-b last">
        <div class="container">
          <div class="row">
            <div class="col-lg-6  col-sm-6">
                <hr class="section-heading-spacer" />
                ...
                <p class="lead">For information regarding private lessons, performances, or other engagements please feel free to reach me at <a href="mailto:thigpen.katie@gmail.com">thigpen.katie@gmail.com</a></p>
                <p class="lead">
                  <a target="_blank" href="https://www.facebook.com/katiethigpen"><i class="icon-facebook-squared"></i></a>
                  <a target="_blank" href="https://www.linkedin.com/pub/katie-thigpen/81/159/1ba"><i class="icon-linkedin-squared"></i></a>
                </p>
            </div>
            <div id="map-container" class="col-lg-6  col-sm-6">
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <p class="copyright text-muted small">Copyright &copy; Katie Thigpen 2017. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </footer>
